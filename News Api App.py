...
class NewsApp:
    ...
    def __init__(self):
        ...
        self.data = requests.get("API KEY").json()
        # initial GUI load

        self.load_gui()
        # load the 1st neimport io
    ...
    def load_news_item(self,index):
        ...
        heading = Label(self.root,text=self.data['articles'][index]['title'],bg='black',fg='white',wraplength=370,justify='center')
        heading.pack(pady=(10,20))
        heading.config(font=('verdana',15))

        details = Label(self.root, text=self.data['articles'][index]['description'], bg='black', fg='white', wraplength=370,justify='center')
